...
with menu_col:
    ...
    with st.container(border=True):
        ...
        st.info("כאן תוכלו לבחור איזה נתונים לראות: באיזה ימי מחקר להתמקד (אמצע שבוע או סופי שבוע), איזה סקר להציג מבין הגלים שנערכו (לכל מחקר היו שני גלים שמוצגים בנפרד או כממוצע) ובאיזה אוכלוסייה להתמקד (אפשר לבחור אוכלוסייה רק כאשר מציגים ממוצע של שני גלים)")
