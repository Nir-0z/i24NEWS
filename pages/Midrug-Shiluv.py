...
if not q_list: st.stop()

with st.columns([1.3, 2.5])[0].container(border=True):
...
if labels:
    ...
    st.columns([1.3, 2.5])[1].plotly_chart(fig, use_container_width=True, config={'displayModeBar': False})
